  ...
  return <>
    <div className="screen dashboard-screen">
      ...
      <div className="dashboard-columns">
        <section className="dashboard-primary"><div className="section-title-row"><h2 className="disp">{de ? "Kommende Fristen" : en ? "Upcoming deadlines" : sr ? "Predstojeći rokovi" : S.kompas.ctaNextSteps}</h2><button className="section-cta" onClick={() => dispatch({ type: "NAV", view: "rokovi" })}>{de ? "Alle Fristen" : en ? "View all deadlines" : sr ? "Pogledaj sve rokove" : S.nav.rokovi} →</button></div>
