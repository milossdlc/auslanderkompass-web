...
export function Kompas({ state, dispatch }: { state: AppState; dispatch: Dispatch<Action> }) {
  ...
  return <>
    <div className="screen dashboard-screen">
      ...
      <section className="personal-focus card"><div className="focus-icon"><Icon name="compass" size={20}/></div><div><div className="eyebrow">{focus.reason}</div><h2 className="disp">{focus.title}</h2><p>{focus.text}</p></div></section>
